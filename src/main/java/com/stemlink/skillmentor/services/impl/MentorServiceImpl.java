...
public class MentorServiceImpl implements MentorService {
    ...
    public Mentor createNewMentor(Mentor mentor){
        try{
            ...
            throw new SkillMentorException("Failed to create new member", HttpStatus.CONFLICT);
        }
    ...
    public Mentor getMentorById(Long id){
        ...
        try {
            ...
            throw new SkillMentorException("Failed to get member", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
